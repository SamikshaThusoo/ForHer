...
import {
  ScanLine, Moon, ArrowRight, Check, Footprints, TrendingUp, Droplet, MessagesSquare, Stethoscope, FileUp, FlaskConical,
} from "lucide-react";
...
/** The ever-changing For Her carousel + a pinned Scan affordance. Care-plan only.
 *  Swipe to move between cards. */
export function ForHerHub() {
  ...
  const showMood = fh.day % 3 === 1; // mood check-in on a cadence, not every day

  return (
    <>
      {/* Scan is always available — pinned, not buried in the carousel */}
